...
CREATE TABLE `class_assignments` (
  ...
  `role` VARCHAR(100) DEFAULT 'Huynh trưởng phụ trách' COMMENT 'Vai trò (Huynh trưởng phụ trách, GLV đứng lớp, Trợ tá...)',
  `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- Phân công GLV vào các lớp
INSERT INTO `class_assignments` (`class_id`, `teacher_id`, `role`) VALUES
('DBKT_2627', 'GLV05', 'Huynh trưởng phụ trách'),
('DBKT_2627', 'GLV24', 'GLV đứng lớp'),
('KT1_2627', 'GLV01', 'Huynh trưởng phụ trách'),
('KT1_2627', 'GLV11', 'GLV đứng lớp'),
('KT2_2627', 'GLV22', 'Huynh trưởng phụ trách'),
('KT2_2627', 'GLV38', 'GLV đứng lớp'),
('KT2_2627', 'GLV36', 'Trợ tá'),
('RL1_2627', 'GLV25', 'Huynh trưởng phụ trách'),
('RL1_2627', 'GLV07', 'GLV đứng lớp'),
('RL1_2627', 'GLV06', 'GLV đứng lớp'),
('RL2_2627', 'GLV31', 'Huynh trưởng phụ trách'),
('RL2_2627', 'GLV35', 'GLV đứng lớp'),
('RL2_2627', 'GLV21', 'GLV đứng lớp'),
('RL2_2627', 'GLV32', 'Trợ tá'),
('TS1_2627', 'GLV04', 'Huynh trưởng phụ trách'),
('TS1_2627', 'GLV23', 'GLV đứng lớp'),
('TS1_2627', 'GLV34', 'Trợ tá'),
('TS2_2627', 'GLV12', 'Huynh trưởng phụ trách'),
('TS2_2627', 'GLV27', 'GLV đứng lớp'),
('TS2_2627', 'GLV09', 'GLV đứng lớp'),
('TS2_2627', 'GLV02', 'GLV đứng lớp'),
('TS2_2627', 'GLV15', 'Trợ tá'),
('TS2_2627', 'GLV40', 'Trợ tá'),
('BD1_2627', 'GLV13', 'Huynh trưởng phụ trách'),
('BD1_2627', 'GLV26', 'GLV đứng lớp'),
('BD1_2627', 'GLV29', 'Trợ tá'),
('BD2_2627', 'GLV03', 'Huynh trưởng phụ trách'),
('BD2_2627', 'GLV08', 'GLV đứng lớp'),
('BD2_2627', 'GLV10', 'GLV đứng lớp'),
('BD2_2627', 'GLV30', 'GLV đứng lớp'),
('BD2_2627', 'GLV39', 'Trợ tá'),
('BD3_2627', 'GLV14', 'Huynh trưởng phụ trách'),
('BD3_2627', 'GLV18', 'GLV đứng lớp'),
('BD3_2627', 'GLV28', 'Trợ tá'),
('VD1_2627', 'GLV16', 'Huynh trưởng phụ trách'),
('VD1_2627', 'GLV17', 'GLV đứng lớp'),
('VD1_2627', 'GLV20', 'GLV đứng lớp'),
('VD1_2627', 'GLV41', 'Trợ tá'),
('VD2_2627', 'GLV19', 'Huynh trưởng phụ trách'),
('VD2_2627', 'GLV37', 'GLV đứng lớp');
